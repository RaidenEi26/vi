...
let handler = async (m, { conn }) => {
  try {
    ...
    let mainmenu = `Anos Ai is a WhatsApp bot for creating stickers, listening to music, and playing real-time RPG games.\n\nAnos Ai also maintains user privacy by destroying stored data every week, ensuring your data remains secure and private.

◦  *Version :* ${version}
◦  *Author :* ${author}
◦  *Show all menu :* .allmenu
◦  *Show about Anos Ai :* .about`;
    ...
    let thumbnailUrl = "https://cdn.jsdelivr.net/gh/SazumiVicky/Storage@main/anang.jpeg";

    let sourceUrl = "https://anangpedia.dev";
    let wait = '*ʟᴏᴀᴅɪɴɢ...*';
    ...
    await conn.sendMessage(m.chat, {
      ...
      contextInfo: {
        ...
        //  body: `${global.sazumi_version}`,
          ...
          sourceUrl: "https://chat.whatsapp.com/HUBS21L2XLH1yAlbxqnevw",
          mediaType: 1,
